...
@section('title','Manage Exam Criteria')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Exam Criteria</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Exam Criteria</a>
                </li>
                <li class="nav-item">
                        <a href="{{ url('exam-criteria/create') }}" class="nav-link">
                        Add Exam Criteria
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($items as $key => $item)
                        <tr>
                            ...
                            <td>{{ $item->status ?? '' }}</td>
                            <td>
                                <a href="{{ url('exam-criteria/' . $item->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>

                                <form method="POST" action="{{ url('exam-criteria/' . $item->id) }}" style="display:inline">
                                    @csrf
                                    @method('DELETE')
...
//                    orientation : 'landscape',
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = ['20%', '70%', '10%'];

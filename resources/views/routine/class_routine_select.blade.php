...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Weekly Timetable</a>
    </li>
@endsection
@push('css')
    ...
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="{{ route("class-routine.create") }}" method="get" id="saveForm">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3{{ $errors->has('shift') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label"> Select shift : <span class="required"> * </span></label>
                            <div class=" col-md-6">

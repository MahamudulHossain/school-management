...
@section('title','Add Subject Class Mapping')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('subject-class-mapping')}}" class="nav-link">Subject Class Mapping</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Add Subject Class Mapping</a>
    </li>
@endsection
@push('css')
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Add Subject Class Mapping</h3>
                </div>
                <form id="saveForm" method="POST" action="{{ url('subject-class-mapping') }}" class="form-horizontal">
                {{ csrf_field() }}

...
@section('content')
    <div class="container ">
        <div class="col-md-9">
            ...
            {{--</div>--}}
            <h1> {{ config('app.name', 'EIS') }} <br/>Laravel 12 Boiler Plate</h1>
        ...
        <div class="footer">
            <a href="https://www.hossainn.com" target="_blank" class="btn btn-sm blue slidebut">
                <span>Powered By : </span>Hossainn
            </a>
        </div>
    </div>
@endsection

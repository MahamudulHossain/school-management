...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Update Transport</a>
    </li>
@endsection
@push('css')
@endpush
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Update Transport Info</h3>
                </div>
                <form action="{{ route("transport.update", $transport->id) }}" method="POST" id="saveForm">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="title" class="form-control" value="{{ $transport->title }}" required />
                                @if($errors->has('title'))
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('route_info') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="route_info" class="form-control" value="{{ $transport->route_info }}" required />
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('vehicle_info') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="vehicle_info" class="form-control" value="{{ $transport->vehicle_info }}" required />
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('driver_info') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="driver_info" class="form-control" value="{{ $transport->driver_info }}" required />
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('fare') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="number" name="fare" class="form-control" value="{{ $transport->fare }}" required />
                                @if($errors->has('fare'))
                                    <em class="invalid-feedback">
                                        {{ $errors->first('fare') }}
                                    </em>

    ...
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="{{ route("subject.store") }}" method="POST" id="saveForm">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('subject_name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="subject_name" name="subject_name" class="form-control" autofocus

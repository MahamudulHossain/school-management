...
@section('term','active')
@section('add_term','active')
@section('title','Add Term/Semester')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('term')}}" class="nav-link">Term/Semester</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Add Term/Semester</a>
    </li>
@endsection
@push('css')
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Add Term/Semester</h3>
                </div>
                <form action="{{ route("term.store") }}" method="POST" id="saveForm">
                    @csrf
                    <div class="card-body">

...
@section('title','Manage Term')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('term')}}" class="nav-link">Term/Semester</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Terms</a>
    </li>
@endsection
@push('css')
    ...
    <div class="card card-success card-tabs">
        <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                ...
                <li class="nav-item">
                        <a href="{{ url('term/create') }}" class="nav-link">
                        Add Term
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($terms as $key => $term)
                        <tr>
                            ...
                            <td>{{ $term->title ?? '' }}</td>
                            <td>
                                <a href="{{ url('term/' . $term->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('term/' . $term->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}

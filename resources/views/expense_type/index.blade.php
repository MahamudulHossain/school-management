...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Expense Type</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Expense Type</a>
                </li>
                <li class="nav-item">
                        <a href="{{ url('expense-type/create') }}" class="nav-link">
                        Add Expense Type
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <tbody>
                    @foreach($expense_types as $key => $expense_type)
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>{{ $expense_type->expense_name ?? '' }}</td>
                            <td>
                                <a href="{{ url('expense-type/' . $expense_type->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>

                                <form method="POST" action="{{ url('expense-type/' . $expense_type->id) }}" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"

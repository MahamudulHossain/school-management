...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Update Expense Type</a>
    </li>
@endsection
@push('css')
    ...
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="{{ route('expense-type.update', $expense_type->id) }}" method="POST" id="saveForm">
                    @method('PATCH')
                    @csrf
                    <div class="card-body">
                        <div class="form-group row mb-3{{ $errors->has('expense_name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="expense_name" name="expense_name" class="form-control"
                                    value="{{ old('expense_name', isset($expense_type) ? $expense_type->expense_name : '') }}" required>

...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Carousel</a>
    </li>
@endsection
@push('css')
    ...
    <div class="card card-success card-tabs">
        <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                ...
                <li class="nav-item">
                        <a href="{{ url('carousel/create') }}" class="nav-link">
                        Add Carousel
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($carousels as $key => $carousel)
                        <tr>
                            ...
                            <td>
                                <img
                            src="{!! asset( 'storage/front/carousel/'. $carousel->image. '?'. 'time='. time()) !!}"
                            class="img-fluid" alt="User Image" width="350px" height="150px">
                            </td>
                            <td>
                                {{ $carousel->serial ?? '' }}
                            </td>

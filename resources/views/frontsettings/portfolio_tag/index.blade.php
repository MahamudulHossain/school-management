...
@section('title','Portfolio Tag')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Portfolio Tag</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Portfolio Tag</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('portfolio-tag.create') }}">Add New</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $key=>$datum)
                                <tr>
                                    ...
                                    <td class="noprint">
                                        <a href="{{ url('/portfolio-tag/' . $datum->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                    </td>

...
@section('add_portfolio','active')
@section('title','Add Portfolio')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Add Portfolio</a>
    </li>
@endsection
@push('css')
@endpush
    ...
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="{{ route("portfolio.store") }}" method="POST" id="saveForm" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">

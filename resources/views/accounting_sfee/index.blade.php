    ...
    <div class="card card-success card-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Fee</a>
                </li>
                <li class="nav-item">
                        <a href="{{ url('sFee/create') }}" class="nav-link">
                        Add Fee
                    </a>
                </li>
            </ul>
        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <tbody>
                    @foreach($accounting_sfees as $key => $fee)
                        <tr>
                            <td>
                                {{$key+1}}
                            </td>
                            <td>
                                {{ $fee->student_class->class_name ?? '' }}
                            </td>
                            <td>
                                {{ $fee->fee_name ?? '' }}
                            </td>
                            ...
                            <td>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('sFee/' . $fee->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}
                                    <form method="POST" action="{{ url('sFee/' . $fee->id) }}" style="display:inline">
                                        @csrf
                                        @method('DELETE')

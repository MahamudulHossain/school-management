...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Employee Attendance Report</a>
    </li>
@endsection
    ...
    <div class="card card-success card-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Employee Attendance Report of {{$employeeName}}</a>
                </li>
        ...
        <div class="card-body">
            <table class="table dataTables table-striped table-bordered table-hover">
                ...
                @foreach ($attendance_employee as $key => $dp)
                    <tr>
                        <td>{{ $key+1 }}</td>
...
//                {targets: [4], className: 'text-right'},
            ...
            buttons: [
                ...
                {extend: 'csv'},
                {
                    ...
                    messageTop: " Employee Attendance of {{$employeeName}}"
                },
...

                {
                    ...
                    filename: 'Employee Attendance of {{$employeeName}}',
                    extension: '.pdf',
//                    orientation : 'landscape',
                    orientation: 'portrait',
                    title: "Employee Attendance of {{$employeeName}}",
                    footer: true,
                    exportOptions: {
                                ...
                                columns: [
                                    {
                                        alignment: 'left',
                                        italics: true,
                                        text: 'Employee Attendance {{$employeeName}}',
                                        fontSize: 10,
                                        margin: [10, 0]
                                    },
                                    // {

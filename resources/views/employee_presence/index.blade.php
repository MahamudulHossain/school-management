...
@section('employee_manage_attendance','active')
@section('title','Manage Attendance')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Attendance</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Manage Attendance</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach($t_presence as $key => $tp)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('employee_presence/' . $tp->date ) }}" class="btn btn-primary btn-sm" role="button">View Attendance</a>
                                <a href="{{ url('employee_presence/' . $tp->date. '/edit' ) }}" class="btn btn-info btn-sm" role="button">Update Attendance</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>

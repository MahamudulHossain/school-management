...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Student Attendance Report</a>
    </li>
@endsection
    ...
    <div class="card card-success card-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Student Attendance Report of {{$studentName}}</a>
                </li>
        ...
        <div class="card-body">
            <table class="table dataTables table-striped table-bordered table-hover">
                ...
                @foreach ($attendance_student as $key => $stu)
                    <tr>
                        <td>{{ $key+1 }}</td>
                        <td>{{ Carbon\Carbon::parse($stu->date)->format('d-M-Y') ?? '' }}</td>
...
//            dom: '<"html5buttons"B>lTfgtip',
            ...
            buttons: [
                ...
                {extend: 'csv'},
                {
                    ...
                    messageTop: " Student Attendance of {{$studentName}}"
                },
...

                {
                    ...
                    filename: 'Student Attendance of {{$studentName}}',
                    extension: '.pdf',
//                    orientation : 'landscape',
                    orientation: 'portrait',
                    title: "Student Attendance of {{$studentName}}",
                    footer: true,
                    exportOptions: {
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = ['10%', '80%', '10%'];

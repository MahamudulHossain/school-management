    ...
    <div class="card card-success card-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Student Attendance Report</a>
                </li>
        ...
        <div class="card-body">
            <table class="table dataTables table-striped table-bordered table-hover">
                ...
                @foreach ($attendance_students as $key => $stu)
                    <tr>
                        <td>{{ $stu->student->user->personnel_id }}</td>
                        <td>{{ $stu->student->first_name }} {{ $stu->student->middle_name }} {{ $stu->student->last_name }}</td>
                        <td>{{$stu->roll}}</td>
...
//                    orientation : 'landscape',
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = ['10%', '40%', '10%', '30%', '10%'];

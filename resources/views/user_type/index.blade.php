...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Manage User Type</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">User Type </a>
                </li>
                <li class="nav-item">
                    @can('UserTypeAccess')
                        <a class="nav-link" href="{{ url('user-type/create') }}" role="tab" aria-controls="custom-tabs-one-profile"
                           aria-selected="false">Add User Type</a>
                    @endcan
                </li>
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover">
                        ...
                        @foreach($user_types as $key => $user_type)
                            <tr>
                                ...
                                <td>
                                    @foreach($user_type->user_type_role as $key => $item)
                                        <span class="badge text-bg-primary">{{ $item->title }}</span>
                                    @endforeach
                                </td>

                                <td>
                                    <a href="{{ url('user-type/' . $user_type->id) }}" class="btn btn-success btn-xs"
                                       title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                    @can('RoleAccess')
                                        <a href="{{ url('user-type/' . $user_type->id . '/edit') }}"

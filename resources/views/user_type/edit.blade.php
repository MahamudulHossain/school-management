...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Update User Type</a>
    </li>
@endsection
@push('css')
    ...
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="{{ route("user-type.update", $user_type->id) }}" method="POST" enctype="multipart/form-data" id="saveForm">
                    @method('PATCH')
                    @csrf
                    <div class="card-body">

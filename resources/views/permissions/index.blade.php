...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Permission</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Permission </a>
                </li>
                {{--@can('permission-access')--}}
                    <li class="nav-item">
                        <a href="{{ url('permission/create') }}" class="nav-link">
                            Add Permission
                        </a>
                    </li>
                {{--@endcan--}}
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover">
                        ...
                        @foreach($permissions as $key => $permission)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('permission/' . $permission->id ) }}" class="btn btn-success btn-xs"

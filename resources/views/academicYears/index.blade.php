...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('academicYear')}}" class="nav-link">Academic Years</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Academic Years</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Academic Years</a>
                </li>
                <li class="nav-item">
                        <a href="{{ url('academicYear/create') }}" class="nav-link">
                        Add Academic Year
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($academicYears as $key => $academicYear)
                        <tr>
                            ...
                            <td>
                                {{ $academicYear->start_date ? Carbon\Carbon::parse($academicYear->start_date)->format('d-M-Y') : '' }}
                            </td>
                            <td>
                                {{ $academicYear->end_date ? Carbon\Carbon::parse($academicYear->end_date)->format('d-M-Y') : '' }}
                            </td>
                            <td>
                                {{ $academicYear->description ?? '' }}
                            </td>
                            <td>
                                <a href="{{ url('academicYear/' . $academicYear->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('academicYear/' . $academicYear->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}
            ...
            buttons: [
...

                {
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = ['10%', '20%', '25%', '25%', '20%'];

...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('schoolClass')}}" class="nav-link">Classes</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Classes</a>
    </li>
@endsection
@push('css')
    ...
    <div class="card card-success card-tabs">
        <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                ...
                <li class="nav-item">
                        <a href="{{ url('schoolClass/create') }}" class="nav-link">
                        Add Class
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($schoolClasses as $key => $schoolClass)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('schoolClass/' . $schoolClass->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('schoolClass/' . $schoolClass->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}

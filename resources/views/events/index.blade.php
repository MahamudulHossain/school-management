...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage events</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Manage Events</a>
                </li>
                <li class="nav-item">
                        <a href="{{ url('event-holiday/create') }}" class="nav-link">
                        Add Events
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($events as $key => $event)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('event-holiday/' . $event->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('event-holiday/' . $event->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}
            ...
            buttons: [
...

                {
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = ['10%', '20%', '30%','30%','10%'];

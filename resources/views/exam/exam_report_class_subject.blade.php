            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">{{ isset($exams[0]) ? $exams[0]->student_class->class_name : '' }} Exam Report of {{ isset($subject_total[0]) ? $subject_total[0]->subject_name : '' }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill"
                       href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home"
                       aria-selected="true">Subjet wise details Marks</a>
                </li>
                    ...
                    <table class="table dataTables2 table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            @foreach($exams as $key=>$exam)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ $exam->user->student->first_name }} {{ $exam->user->student->middle_name }} {{ $exam->user->student->last_name }}</td>
                                    <td>
                                        {{ $exam->roll }}
                                    </td>
                                    <td>
            ...
            buttons: [
                ...
                },
                {
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = ['10%', '30%', '5%', '15%','10%','10%','10%','10%'];
            ...
            buttons: [
                ...
                },
                {
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = ['10%', '30%', '10%', '35%','15%'];
                        doc.content.splice(0, 1);
                        var now = new Date();
                        var jsDate = now.getDate() + '-' + (now.getMonth() + 1) + '-' + now.getFullYear() + ' ' + now.getHours() + ':' + now.getMinutes() + ':' + now.getSeconds();
                        var logo = '';
                ...
                },
                {
                    extend: 'print',
                    footer: true,
                    messageTop: 'Subjectwise Exam Report ',
                    messageBottom: '{{'Printed On: '.\Carbon\Carbon::now()->format(' D, d-M-Y, h:ia')}}',
                    customize: function (win) {
                        $(win.document.body).addClass('white-bg');
                        $(win.document.body).css('font-size', '10px');

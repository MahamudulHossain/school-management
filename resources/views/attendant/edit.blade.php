...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Edit Attendant</a>
    </li>
@endsection
@push('css')
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Update Attendant</h3>
                </div>
                <form id="saveForm" method="POST" action="{{ route('attendant.update',$attendant->id) }}" class="form-horizontal" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-3{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="name"
                                   value="{{ $attendant->name }}" autocomplete="false" autofocus
                    ...
                    <div class="form-group row mb-3{{ $errors->has('contact_no') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="contact_no" type="text" class="form-control" name="contact_no"
                                   value="{{ $attendant->contact_no }}" placeholder="Mobile Number"
                    ...
                    <div class="form-group row mb-3{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="email"  class="form-control" name="email" value="{{ $attendant->email }}"/>
                            @if ($errors->has('email'))
                                <span class="help-block">
                    ...
                    <div class="form-group row mb-3{{ $errors->has('nid') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="nid" type="number"  class="form-control" name="nid" value="{{ $attendant->nid }}"/>
                            @if ($errors->has('nid'))
                                <span class="help-block">
                    ...
                    <div class="form-group row mb-3{{ $errors->has('address') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <textarea name="address" id="address" cols="30" rows="5" class="form-control">{{ $attendant->address }}</textarea>
                    ...
                    <div class="form-group row mb-3{{ $errors->has('gender') ? ' has-error' : '' }}">
                        ...
                        <div class=" col-md-6 mt-radio-inline">
                            <label class="mt-radio">
                                <input type="radio" name="gender" value="Male" {{ $attendant->gender == 'Male' ? 'checked':'' }}> Male
                                <span></span>
                            </label>
                            <label class="mt-radio">
                                <input type="radio" name="gender" value="Female" {{ $attendant->gender == 'Female' ? 'checked':'' }}> Female
                                <span></span>
                            </label>
                            <label class="mt-radio">
                                <input type="radio" name="gender" value="Others" {{ $attendant->gender == 'Others' ? 'checked':'' }}> Others
                                <span></span>
                            </label>
                        </div>
                    ...
                    <div class="form-group row mb-3{{ $errors->has('image') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            @endif
                            <div class="mt-3 fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                <img src="{!! asset( 'storage/image_profile/'. $attendant->image. '?'. 'time='. time()) !!}" class="profile-user-img img-fluid img-circle" alt="Attendant Image" style="width: 200px; height: 150px;">
                            </div>
                        </div>
                        <div class="row mt-2">

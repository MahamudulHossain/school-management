...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Attendant</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Attendant</a>
                </li>
                <li class="nav-item">
                        <a href="{{ url('attendant/create') }}" class="nav-link">
                        Add Attendant
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($attendants as $key => $attendant)
                        <tr>
                            ...
                            <td>
                                {{ $attendant->contact_no ?? '' }}
                            </td>
                            <td>
                                <a href="{{ url('attendant/' . $attendant->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>

                                <a href="{{ url('attendant/' . $attendant->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>

                                <form method="POST" action="{{ url('attendant/' . $attendant->id) }}" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <a href="{{ url('attached-list/' . $attendant->id) }}" class="btn btn-primary btn-sm" title="Attached Students"><span class="fa fa-link" aria-hidden="true"></span></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>

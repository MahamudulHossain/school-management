...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('schoolSection')}}" class="nav-link">Sections</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Sections</a>
    </li>
@endsection
@push('css')
    ...
    <div class="card card-success card-tabs">
        <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                ...
                <li class="nav-item">
                        <a href="{{ url('schoolSection/create') }}" class="nav-link">
                        Add Section
                    </a>
                </li>
            </ul>
        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <tbody>
                    @foreach($schoolSections as $key => $schoolSection)
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>{{ $schoolSection->section_name ?? '' }}</td>
                            <td>{{ $schoolSection->priority_no ?? '' }}</td>
                            <td>
                                <a href="{{ url('schoolSection/' . $schoolSection->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('schoolSection/' . $schoolSection->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}

...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Add Notice</a>
    </li>
@endsection
@push('css')
@endpush
    ...
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="{{ route("notice.store") }}" method="POST" id="saveForm" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('details') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input type="file" id="details" name="details" class="form-control" accept=".pdf" required>

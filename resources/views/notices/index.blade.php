...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Notices</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Notices</a>
                </li>
                @can('CreateNotice')
                <li class="nav-item">
                        <a href="{{ url('notice/create') }}" class="nav-link">
                        Add Notice
                    </a>
                </li>
                @endcan
                ...
                <tbody>
                    @foreach($notices as $key => $notice)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('notice/' . $notice->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                @can('EditNotice')
                                    <a href="{{ url('notice/' . $notice->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                @endcan
                                @can('DeleteNotice')

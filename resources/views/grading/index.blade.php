            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Manage Grading</a>
                </li>
                <li class="nav-item">
                        <a href="{{ url('grading/create') }}" class="nav-link">
                        Add Grading
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($grades as $key => $grade)
                        <tr>
                            ...
                            <td>
                                {{ $grade->starting_marks.' to '.$grade->ending_marks ?? '' }}
                            </td>
                            <td>
                                {{ $grade->remarks ?? '' }}
                            </td>
                            <td>
                                <a href="{{ url('grading/' . $grade->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('grading/' . $grade->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}
                                    <form method="POST" action="{{ url('grading/' . $grade->id) }}" style="display:inline">
                                        @csrf
                                        @method('DELETE')
            ...
            buttons: [
                ...
                },
                {
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = ['10%', '20%', '20%', '25%', '25%'];

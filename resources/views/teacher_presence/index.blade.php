...
@section('teacher_manage_attendance','active')
                ...
                <tbody>
                    @foreach($t_presence as $key => $tp)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('teacher_presence/' . $tp->date ) }}" class="btn btn-primary btn-sm" role="button">View Attendance</a>
                                @can('TeacherPresenceUpdate')
                                <a href="{{ url('teacher_presence/' . $tp->date. '/edit' ) }}" class="btn btn-info btn-sm" role="button">Update Attendance</a>
                                @endcan
                            </td>
                        </tr>
                    @endforeach

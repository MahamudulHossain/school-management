...
@section('title','Teacher Attendance Report Report')
@push('css')
...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Teacher Attendance Report Report</a>
    </li>
@endsection
    ...
    <div class="card card-success card-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Teacher Attendance Report Report</a>
                </li>
        ...
        <div class="card-body">
            <table class="table dataTables table-striped table-bordered table-hover">
                ...
                @foreach ($attendance_teachers as $key => $dp)
                    <tr>
                        <td>{{ $key+1 }}</td>
                        <td>
...
//                {targets: [4], className: 'text-right'},
            ...
            buttons: [
                ...
                {extend: 'csv'},
                {
                    ...
                    messageTop: ' Teacher Attendance Report   '
                },
...

                {
                    ...
                    filename: 'Teacher Attendance Report ',
                    extension: '.pdf',

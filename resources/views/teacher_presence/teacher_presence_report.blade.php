...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Teacher Attendance Report</a>
    </li>
@endsection
@push('css')
                    ...
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill"
                               ...
                               aria-selected="false">Teacher wise report</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                            ...
                            <div>
                                ...
                                <form action="{{ url('teacher_attendance_reportbyrange') }}" method="POST" class="form-horizontal">
                                    @csrf
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel"
                            ...
                            <div>
                                <div>
                                    <div class="caption">
                                        <i class="fa fa-gift"></i> Teacher wise Attendance Report
                                    </div>
                                </div>

                                <form action="{{ url('attendance_report_byteacher') }}" method="POST" class="form-horizontal">
                                    @csrf
                                    <div class="form-group text-center">
                                            ...
                                            <div style="width: 100%">
                                                <select name="user_id" id="user_id" class="form-control" required>
                                                    ...
                                                    @foreach ($teachers as $t)
                                                        <option value="{{ $t->id }}">
                                                            {{ $t->teacher->first_name.' '.$t->teacher->middle_name.' '.$t->teacher->last_name}}
                                                            {{ $t->personnel_id }}
                                                        </option>
                                                    @endforeach
                                                </select>

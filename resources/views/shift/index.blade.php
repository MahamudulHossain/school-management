...
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage shift</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Manage Shifts</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach($data as $key => $datum)
                        <tr>
                            ...
                            <td>
                                {{ $datum->shift_id == 0 ? 'Morning' : 'Day' }}
                            </td>
                            <td>
                                {{ $datum->pn ?? '' }}
                            </td>
                            <td>
                                <a href="{{ url('shift/' . $datum->shift_id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>

                                <a href="{{ url('shift/' . $datum->shift_id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                            </td>

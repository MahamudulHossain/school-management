...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Add Leave Type</a>
    </li>
@endsection
@push('css')
    ...
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <form action="{{ route("leave-type.store") }}" method="POST" id="saveForm">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('leave_type_name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="leave_type_name" name="leave_type_name" class="form-control" autofocus
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('comments') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="comments" name="comments" class="form-control" autofocus
                                    value="{{ old('comments', isset($leave_type) ? $leave_type->comments : '') }}">

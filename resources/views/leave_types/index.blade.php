...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="javascript:void(0)" class="nav-link">Manage Leave Types</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Leave Types</a>
                </li>
                <li class="nav-item">
                        <a href="{{ url('leave-type/create') }}" class="nav-link">
                        Add Leave Type
                    </a>
                </li>
            </ul>
                ...
                <tbody>
                    @foreach($leave_types as $key => $leave_type)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('leave-type/' . $leave_type->id) }}" class="btn btn-success btn-sm" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('leave-type/' . $leave_type->id . '/edit') }}" class="btn btn-info btn-sm" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}
